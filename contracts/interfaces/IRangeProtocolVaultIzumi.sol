...
interface IRangeProtocolVaultIzumi is IERC20Upgradeable, IiZiSwapCallback, IiZiSwapMintCallback {
    struct UserVault { 
        bool exists;
        uint256 tokenX;
        uint256 tokenY;
    ...
    function userVaults(address user) external view returns (UserVault memory);
